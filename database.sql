...
INSERT INTO Train_Segment VALUES
	(6607, 'Paris', 'Lyon', 310.00, 1),					
    (6607, 'Lyon', 'Avignon', 153.33, 2),					
    (6607, 'Avignon', 'Marseille', 210.00, 3),				

	(6650, 'Strasbourg', 'Lyon', 141.43, 1),				
    (6650, 'Lyon', 'Avignon', 138.00, 2),					
    (6650, 'Avignon', 'Montpellier', 95.00, 3),			

	(6632, 'Marseille', 'Avignon', 157.50, 1),				
    (6632, 'Avignon', 'Lyon', 138.00, 2),						
    (6632, 'Lyon', 'Paris', 174.38, 3);					
